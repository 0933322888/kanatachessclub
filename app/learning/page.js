...
export default function LearningPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <div className="relative h-[400px] w-full flex items-center justify-center text-center text-white mb-12">
        <div className="absolute inset-0 z-0">
          <img
            src="/images/learning_chess_hero.png"
            alt="Chess Study"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-whisky-900/70" />
        </div>
        <div className="relative z-10 px-4">
          <h1 className="text-5xl md:text-6xl font-bold font-serif mb-4 text-amber-light">
            Learning Chess
          </h1>
